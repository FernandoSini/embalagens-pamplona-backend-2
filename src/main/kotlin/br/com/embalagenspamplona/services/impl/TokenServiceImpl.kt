...
class TokenServiceImpl : TokenService {
    ...
    fun initTokenService() {
        ...
        signingKey = SecretKeySpec(keyBytes, "HmacSHA256")
    }
    ...
    override fun isTokenValid(
        ...
        try {
            ...
            throw Exception("Token de acesso inválido Jwt: ${e.message}")
        }
    }
    ...
    override fun getAuthentication(
        ...
        try {
            ...
            if (userInfo != null) {
                ...
                throw Exception("Usuário não encontrado para fazer autenticacao")
            }
        } catch (e: Exception) {
