...
import br.com.embalagenspamplona.repository.datasource.local.*
import br.com.embalagenspamplona.services.CartService
import br.com.embalagenspamplona.services.CouponService
    ...
    private fun getOrCreateCart(customerId: Long): CartEntity {
        return cartRepository.findByUserEntityIdWithItems(customerId)
            ?: run {
                ...
                cartRepository.save(CartEntity(userEntity = customerEntity, order = OrderEntity(user = customerEntity!!)))
            }
    }
