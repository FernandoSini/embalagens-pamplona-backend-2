...
import br.com.embalagenspamplona.data.dto.PromotionDTO
...
import br.com.embalagenspamplona.services.SegmentService
...
class SegmentServiceImpl(
    ...
    private fun SegmentEntity.toDTO(): SegmentDTO {
        val productCount = productRepository.countBySegmentIdAndActiveTrue(this.id)
        return SegmentDTO(
            id = this.id,
