...
class PaymentController(
    ...
    fun getPaymentById(@PathVariable paymentId: UUID): ResponseEntity<ApiResponse<PaymentDTO>> {
    ...
    fun cancelPayment(@PathVariable paymentId: UUID): ResponseEntity<ApiResponse<PaymentDTO>> {
